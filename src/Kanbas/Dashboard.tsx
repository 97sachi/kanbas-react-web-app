...
export default function Dashboard(
  ...
  // const handleToggleEnrolling = async () => {
  //   if (!enrolling) {
  //     // If switching to "All Courses" and allCourses not fetched yet
  //     try {
  ...
  //     }
  //   }
  //   setEnrolling(!enrolling); // Toggle the view
  // };

  // Determine which courses to display based on the enrolling state
  // const displayedCourses = enrolling ? allCourses : enrolledCourses;
